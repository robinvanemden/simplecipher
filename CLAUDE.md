...
`tests/test_p2p.c` — 610 tests covering crypto, DH ratchet, TCP loopback handshake, bidirectional messaging, tamper detection, replay rejection, forward secrecy, post-compromise security, KDF known-answer vectors, constant-time verification, SOCKS5 request building, peer fingerprint verification, cover traffic, transactional ratchet receive. Must pass before any release.
