...
```bash
make test                      # 1036 P2P tests (test_p2p only)
make test-all                  # 1062 total: 1036 P2P + 10 SOCKS5 + 16 CLI flag tests
```
