...
| Android has no cover traffic | JNI event loop lacks the dummy-frame scheduler; Tor timing correlation is unmitigated on Android | `ANDROID.md:SOCKS5 / Tor support` |
