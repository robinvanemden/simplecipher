...
/**
 * Abstraction for QR code operations. The 'full' flavor provides a real implementation (ZXing); the
 * 'minimal' flavor provides a no-op stub. This lets MainActivity compile identically for both
 * flavors.
 */
interface QrHelper {
